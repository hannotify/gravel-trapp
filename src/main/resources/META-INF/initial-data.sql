...
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Bahrain Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Saudi Arabian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Australian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Azerbaijan Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Miami Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Emilia Romagna Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Monaco Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Spanish Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Canadian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Austrian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'British Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Hungarian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Belgian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Dutch Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Italian Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Singapore Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Japanese Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Qatar Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'United States Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Mexico City Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'São Paulo Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Las Vegas Grand Prix', 2024, 'REGULAR');
insert into RACE (id, name, raceYear, raceType) values (uuid(), 'Abu Dhabi Grand Prix', 2024, 'REGULAR');
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Australian Grand Prix'), (select id from DRIVER where name = 'Oscar Piastri'), 8, false);
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Australian Grand Prix'), (select id from DRIVER where name = 'Fernando Alonso'), 9, false);
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Australian Grand Prix'), (select id from DRIVER where name = 'Esteban Ocon'), 10, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Azerbaijan Grand Prix'), (select id from DRIVER where name = 'Carlos Sainz'), 6, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Azerbaijan Grand Prix'), (select id from DRIVER where name = 'Esteban Ocon'), 10, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Miami Grand Prix'), (select id from DRIVER where name = 'George Russell'), 4, false);
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Miami Grand Prix'), (select id from DRIVER where name = 'Sergio Perez'), 5, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Miami Grand Prix'), (select id from DRIVER where name = 'Esteban Ocon'), 10, false);

insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Emilia Romagna Grand Prix'), (select id from DRIVER where name = 'Max Verstappen'), 1, true);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Emilia Romagna Grand Prix'), (select id from DRIVER where name = 'Oscar Piastri'), 8, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Emilia Romagna Grand Prix'), (select id from DRIVER where name = 'Esteban Ocon'), 10, false);
...
insert into RACERESULT (id, race_id, driver_id, position, fastestLap) values (uuid(), (select id from RACE where name = 'Monaco Grand Prix'), (select id from DRIVER where name = 'Esteban Ocon'), 10, false);
